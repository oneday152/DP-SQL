...
entry = {
    "db_id": "california schools",
    "question": "Consider the average difference between K-12 enrollment and 15-17 enrollment of schools that are locally funded, list the names and DOC type of schools which has a difference above this average.",
    "question_toks": [ "Consider","the","difference","between","K-12","enrollment","and","15-17","enrollment","of","schools","that","are","locally","funded","list","the","names","and","DOC","type","of","schools","which","has","a","difference","above","this","average","."],
}
...
processor = Preprocessor(db_dir=r"Data\dev_databases", db_content=True)

db_processed = processor.preprocess_database(db=db,custom_entities={"NSLP", "K-12", "5-17", "NCES", "SAT", "DOC", "SOC"})
print(db_processed)
preprocessed_entry = processor.preprocess_question(entry, db,custom_entities={"NSLP", "K-12", "5-17", "NCES", "SAT", "DOC", "SOC"}, verbose=True)
print(f"preprocessed_entry: {preprocessed_entry}")

schema_linking = processor.schema_linking(preprocessed_entry, db,custom_entities={"NSLP", "K-12", "5-17", "NCES", "SAT", "DOC", "SOC"}, verbose=True)

print(f"schema_linking: {schema_linking}")
# print(subgraph)
