...
class GraphProcessor():
    ...
    def process_rgatsql(self, ex: dict, db: dict, train_dataset:dict,relation: list,is_tool=False ):
    ...
    def process_graph_utils(self, ex: dict, db: dict, train_dataset:dict, method: str = 'rgatsql', is_tool=False ):
        ...
        ex = self.process_rgatsql(ex, db, train_dataset=train_dataset,relation=relation,is_tool=is_tool)
        return ex